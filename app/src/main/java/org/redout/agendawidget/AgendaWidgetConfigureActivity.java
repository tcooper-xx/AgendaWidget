 ...
 */
public class AgendaWidgetConfigureActivity extends Activity {

    private static final String PREFS_NAME = "org.redout.agendawidget.AgendaWidget";
    private static final String PREF_PREFIX_KEY = "appwidget_";
    int mAppWidgetId = AppWidgetManager.INVALID_APPWIDGET_ID;
    EditText mAppWidgetText;
    View.OnClickListener mOnClickListener = new View.OnClickListener() {
        public void onClick(View v) {
            final Context context = AgendaWidgetConfigureActivity.this;
            ...
            AgendaWidget.updateAppWidget(context, appWidgetManager, mAppWidgetId);
